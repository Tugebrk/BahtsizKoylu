...
public class ActionChooser2 extends CombatObject {

	private ClickListener clicker;
	private TurnTracker turnTracker;

	public ActionChooser2(float x, float y, int width, int height, TurnTracker turnTracker, ClickListener clicker) {
	...
	public void render(Graphics g) {
		...
		g.drawImage(turnTracker.getCurrentCaster().getTurn().getCaster().getClasS().getSkill2().getPortrait(), (int) x,
