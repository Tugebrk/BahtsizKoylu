...
public class WhiteCat extends Creature {
...
//	PLAYER RIGHT
	...
	public WhiteCat(Handler handler, float x, float y) {
...
//		Animation
		animDown= new Animation(100, Assets.wcat_down);
		animLeft= new Animation(100, Assets.wcat_left);
		animRight= new Animation(100, Assets.wcat_right);
		animUp= new Animation(100, Assets.wcat_up);
	}
