...
public class BlackDog extends Creature {
...
//	PLAYER RIGHT
	...
	public BlackDog(Handler handler, float x, float y) {
...
//		Animation
		animDown= new Animation(100, Assets.bdog_down);
		animLeft= new Animation(100, Assets.bdog_left);
		animRight= new Animation(100, Assets.bdog_right);
		animUp= new Animation(100, Assets.bdog_up);
	}
