...
public class YellowDog extends Creature {
...
//	PLAYER RIGHT
	...
	public YellowDog(Handler handler, float x, float y) {
...
//		Animation
		animDown= new Animation(100, Assets.ydog_down);
		animLeft= new Animation(100, Assets.ydog_left);
		animRight= new Animation(100, Assets.ydog_right);
		animUp= new Animation(100, Assets.ydog_up);
	}
