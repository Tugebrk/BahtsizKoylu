...
//	PLAYER RIGHT
	...
	public BlackCat(Handler handler, float x, float y) {
...
//		Animation
		animDown= new Animation(100, Assets.bcat_down);
		animLeft= new Animation(100, Assets.bcat_left);
		animRight= new Animation(100, Assets.bcat_right);
		animUp= new Animation(100, Assets.bcat_up);
	}
