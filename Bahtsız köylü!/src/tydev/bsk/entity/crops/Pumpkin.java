...
public class Pumpkin extends StaticEntity {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.pumpkin, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
